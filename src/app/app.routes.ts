    ...
    children: [
      {
        path: '',
        loadComponent: () =>
          import('lib-home').then((m) => m.BasicHomeComponent),
        data: {
          title: '',
        },
      },
      ...
      },
      {
        path: 'generales',
        loadChildren: () =>
          import('lib-generales').then((m) => m.GeneralesRoutes),
      },
      {
        path: 'mantenimiento',
        loadChildren: () =>
          import('lib-mantenimiento').then((m) => m.MantenimientoRoutes),
      },
      {
        path: 'finanzas',
        loadChildren: () =>
          import('lib-finanzas').then((m) => m.FinanzasRoutes),
      },
      // {
      //     path: 'configuracion',
